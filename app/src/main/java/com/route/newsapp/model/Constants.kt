...
object Constants {
    ...
    val CATEGORIES_NAMES =
        listOf("sports", "politics", "health", "business", "environment", "science")

    val ALL_CATEGORIES = listOf(
        Category(),
        Category(CATEGORIES_NAMES[1], R.drawable.img_politics, R.string.politics, Blue),
        ...
        Category(CATEGORIES_NAMES[4], R.drawable.img_environment, R.string.environment, LightBlue),
